...
passport.use (
  new GoogleStrategy (
    ...
    // This is an arrow function that we we refactored to a Async/Await function above
    ...
    // 	//It always returns a promise and we have to deal with a promise appropiately
    // 	User.findOne({
    // 			googleID: profile.id
    // 		})
